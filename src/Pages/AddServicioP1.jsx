...
const AddServicioP1 = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (text, record) => (
                <Button
                    type="link"
                    onClick={() => navigate(`/addServicio/${record.key}`, { state: { contratoId: record.key } })} // Envía el id del contrato
                >
                    Seleccionar
                </Button>
            ),
    ...
    return (
        <div>
            <Title level={2}>Eleccion de cotrato para su servicio</Title>
            <Divider style={{ marginTop: '20px' }} />
            <div style={{ display: 'flex', justifyContent: 'end', alignItems: 'center', marginBottom: 16 }}>
                <TreeSelect
                    treeData={treeData}
